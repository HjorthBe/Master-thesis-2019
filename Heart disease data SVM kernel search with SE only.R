...
# kernel search on Heart disease data for SVM.
...
# 
res_table_I <- data.frame(matrix(nrow = 9, ncol = 2))
...
# 
res_table_II <- data.frame(matrix(nrow = 10, ncol = 2))
...
ell_se_1 <- 2.5; ell_se_2 <- 1
ell_se_3 <- 0.1; ell_se_4 <- 1.5
o_1 <- 1; o_2 <- 1; o_3 <- 2
metric_eval()
# > metric_eval()
