...
# kernel search on Air passanger data for GP regression.
# The search is performed with base kernels: SE, PER, 
# LIN and RQ.
# ______________________________________________________
...
library(datasets)
# loading the Air passanger data
...
# 
k_se_0 <- function(x, y){# SE kernels
...
# variables used in the k.functions
...
interval_gpr <- seq(0.55, 3.25, 0.45)
# interval_gpr <- seq(0.55, 3.25, 0.45*4)# small interval for test run
